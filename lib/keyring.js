...
tableFields.keys_identities_selfsigned = [ "key", "id", "name", "email", "expires", "revoked", "security" ];
tableFields.keys_attributes = [ "key", "id", "binary", "trust" ];
tableFields.keys_attributes_selfsigned = [ "key", "id", "binary", "expires", "revoked", "security" ];
