...
tableFields.keys_signatures_all = [ "id", "key", "issuer", "date", "binary", "verified", "sigtype", "expires", "revoked", "type", "objectId" ];
...
pgp.utils.extend(_KeyringPostgres.prototype, {
	...
	getSignatureById : function(signatureId, callback, fields) {
		...
		_getEntry(this._con, "keys_signatures_all", { id: signatureId }, fields, pgp.packetContent.getSignaturePacketInfo, function(err, signatureInfo) {
